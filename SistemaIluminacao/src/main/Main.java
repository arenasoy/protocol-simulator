...
public class Main {
	...
	public static void main(String[] args) {
		...
		try {
			i = new Iluminacao(m.group(1).trim(), Integer.parseInt(m.group(2)), p, c.readInt("Quantas fileiras de luz possui o sistema de iluminação?"));
			System.out.println("O servidor esta hospedado em: " + i.getHostAddress() + ":" + i.getPort());
			i.execute();
		} catch(Exception ex) {
